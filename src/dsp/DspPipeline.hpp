 ...
 * window.
 */
class DspPipeline final : public litespec::recorder::IDetectorStateProvider {
public:
    ...
    litespec::recorder::DetectorStateSnapshot snapshot() const override;
